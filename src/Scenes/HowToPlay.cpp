...
namespace HowToPlay
{
	...
	void InitTexts()
	{
		...
		instructionsPlayer1 = Text::CreateText("PLAYER 1: JUMP WITH THE SPACE KEY. You are the PURPLE ONE!", fontSize2, { screenCenterX, screenHeight / 4 }, ColorManager::GetColor(ColorManager::Purple), Text::Fonts::generalText);

		instructionsPlayer2 = Text::CreateText("PLAYER 2: JUMP WITH THE UP KEY. You are the RED ONE!", fontSize2, { screenCenterX, screenHeight / 3 }, ColorManager::GetColor(ColorManager::Red), Text::Fonts::generalText);
